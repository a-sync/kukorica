...
class Movie{
	...
	public function getTrailers() {
		...
		if (!isset($this->_data['trailers']) || ( empty($this->_data['trailers']) && isset($this->_tmdb) )){
			$this->loadTrailer();
		}
	...
	public function getTrailer() {
		...
		return (isset($trailers['youtube'][0]))?$trailers['youtube'][0]['source']:'';
	}
