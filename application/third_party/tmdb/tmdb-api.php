...
class TMDB{
	 ...
	 *
	 * 	@param string ID
	 * 	@return Movie object or FALSE if nothing found
	 */
	public function findMovie($imdb_id){
		$result = $this->_call('find/'.$imdb_id, 'external_source=imdb_id');
